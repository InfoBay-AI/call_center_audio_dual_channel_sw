...
This dataset is a **large-scale collection of raw Swahili call center audio (dual-channel)**, designed to support the development and training of advanced speech and AI systems.
...
**Dataset Specification**
    ...
    -Duration: Swahili(KE) - 13,426 & Swahili(UG) - 1,753         
